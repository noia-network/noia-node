...
// function _closeAll(cb: any): void {
...
// function _connection(cb: any): void {
//     wss.on("connection", (ws: any, req: any) => {
//         cb(ws);
//     });
// }

// function _listen(cb: any): void {
...
//     const node = new Node({
//         [SettingsEnum.ws]: false,
//         [SettingsEnum.http]: false,
//         [SettingsEnum.storageDir]: storageDir,
//         [SettingsEnum.storageSize]: 1048576
//     });
//     node.on("started", () => {
//         setTimeout(() => {
//             node.stop().then(done);
...
//     _listen(() => {
//         const node = new Node({
//             [SettingsEnum.masterAddress]: masterAddress,
//             [SettingsEnum.ws]: false,
//             [SettingsEnum.http]: true,
//             [SettingsEnum.storageDir]: storageDir,
//             [SettingsEnum.storageSize]: 1048576
...
//             [SettingsEnum.ws]: false,
//             [SettingsEnum.http]: true,
//             [SettingsEnum.storageDir]: "./tests/storage/",
//             [SettingsEnum.storageSize]: 1048576
//         });
